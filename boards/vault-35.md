...
![Cain's Personal Vault 35](/image/cain's_personal_vault_35.jpg =50%x)
...
There are a few aftermarket PCBs available that are compatible with the stock Vault 35 case or one of the other cases listed below:
- Pip Boys
- BaulT
- Vault35 Ortho (Galvy)
...
Aside from the cases that come with the Vault 35 kits, there are a few community-made cases:
